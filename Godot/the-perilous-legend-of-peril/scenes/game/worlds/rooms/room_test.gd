...
func dungeon_1():
	...
	print(graph.add_node(0, 'north', 'corridor_along'))
	print(graph.add_node(0, 'east', 'corridor_corner'))
	print(graph.add_node(1, 'west', 'monster'))
	print(graph.add_node(2, 'north', 'corridor_up'))
	print(graph.add_node(4, 'north', 'monster'))
	print(graph.add_node(2, 'east', 'monster'))
	print(graph.add_node(0, 'south', 'corridor_corner'))
	print(len(graph.nodes))
