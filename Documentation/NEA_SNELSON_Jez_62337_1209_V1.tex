...
\section{Design}
        ...
        \begin{tabular}{|c|c|c|}
                ...
                \hline
                \mr{2}{2cm}{createTableUsers}&\mr{2}{3cm}{Create's a table for Users if it does not exist.}&\mr{2}{8cm}{\texttt{CREATE TABLE IF NOT EXISTS Users (\\user\_id INTEGER PRIMARY KEY AUTOINCREMENT\\username VARCHAR(50)}}\\
                &&\\
                &&\\
                &&\\
                \hline
