...
\section{Design}
        ...
        \begin{figure}[H]
                \centering
                \includegraphics[width = 0.9\columnwidth, clip, trim = 0 300 0 25]{images/design/Item_Class_Diagram.pdf}
...
def add_item(item: Resource):
        if len(stored_items) > max_inventory_size + 1:
                return -1 #indicates that the inventory is full
        else:
