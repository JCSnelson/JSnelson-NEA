...
\section{Design}
        ...
        \begin{tabular}{|c|c|c|}
                ...
                &&\\
                \hline
                \mr{2}{3.5cm}{reset\_password}&\mr{2}{3cm}{Changes a users password}&\mr{2}{9.5cm}{\texttt{--Assume hashed password and answer\\UPDATE TABLE users\\SET invalidCount = 0\\WHERE username = ?}}\\
                &&\\
                &&\\
                &&\\
                \hline
