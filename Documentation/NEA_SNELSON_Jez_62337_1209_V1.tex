...
def add_user(username, password, answer):
   ...
   hashed_password = hash(password,salt) #hashing password
   hashed_answer = hash(answer,salt) #hashing answer
...
def reset_password(username, answer, password):
   query_result = get_user_data(username)
   if len(query_result) == 0:
      return "InvalidUsernameError"
   if hash(answer) == query_result["answer"]:
