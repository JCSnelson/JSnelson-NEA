...
\section{Design}
        ...
        \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth, trim = 0 500 0 100, clip]{images/design/Database_Design.pdf}
        ...
        \begin{tabular}{|c|c|c|}
                ...
                \hline
                \mr{2}{3cm}{createTableUsers}&\mr{2}{3cm}{Create's a table for Users if it does not exist.}&\mr{2}{8.5cm}{\texttt{CREATE TABLE IF NOT EXISTS users (\\\tab user\_id INTEGER PRIMARY KEY AUTOINCREMENT,\\\tab username VARCHAR(15) NOT NULL,\\\tab password VARCHAR(64) NOT NULL,\\\tab salt VARCHAR(64) NOT NULL,\\\tab answer VARCHAR(64) NOT NULL\\);}}\\
                &&\\
                &&\\
                &&\\
                &&\\
                ...
                &&\\
                \hline
                \mr{2}{3cm}{getUserData}&\mr{2}{3cm}{Returns the user data assuming it exists. If it doesnt it will return null.}&\mr{4}{8.5cm}{\texttt{SELECT * FROM users\\WHERE username = \%s;}}\\
                &&\\
                &&\\
                &&\\
                \hline
                \mr{2}{3cm}{addNewUser}&\mr{2}{3cm}{Insets a new user into users with username, password, challenge question answer and }&\mr{2}{8.5cm}{\texttt{}}\\
                &&\\
                &&\\
                \hline
        \end{tabular}
        \subsection{Login System (Activity Diagram)}
        \begin{figure}[H]
                \centering
