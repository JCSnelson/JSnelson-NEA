...
\section{Analysis}
        ...
        \begin{tabular}{|c|c|c|c|}
                ...
                &&&\\
                \hline
                        12&\mr{2}{2cm}{Inventory System}&\mr{2}{6cm}{12.1 UI for Inventory\\12.2 Storage of Extra weapons and key items (keys, armour, charms, etc)\\12.3 E key to open up the inventory\\12.4 Ability to switch out what Weapons, Armour and charms are equipped.\\12.5 Ability to add or remove items from the inventory.}&\mr{2}{6cm}{A clear and intuitive menu for managing items.\\ Players can store extra weapons and items to be saved in their inventory.\\ E Key - Open Inventory UI.\\Players can swap weapons/armour.\\Players can remove items from their inventory.}\\
                &&&\\
                &&&\\
                &&&\\
                &&&\\
